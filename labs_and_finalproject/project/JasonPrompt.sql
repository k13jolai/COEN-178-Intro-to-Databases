...
CREATE TABLE Problem_Repair_Job (
  ...
  ProblemProblemID));
ALTER TABLE Warrantys ADD CONSTRAINT FKWarranty476847 FOREIGN KEY (MachineID) REFERENCES Machines (MachineID);
ALTER TABLE Service_Item ADD CONSTRAINT FKMachine68663 FOREIGN KEY (MachineID) REFERENCES Machines (MachineID);
ALTER TABLE Repair_Job ADD CONSTRAINT FKRepair_Job187922 FOREIGN KEY (EmployeeID) REFERENCES Repair_Person (EmployeeID);
ALTER TABLE Repair_Job ADD CONSTRAINT FKRepair_Job632079 FOREIGN KEY (BillID) REFERENCES Bills (BillID);
...
ALTER TABLE Service_Contract ADD CONSTRAINT FKService_Co372277 FOREIGN KEY (CustomerID) REFERENCES Customers (CustomerID);
ALTER TABLE Repair_Job ADD CONSTRAINT FKRepair_Job11782 FOREIGN KEY (CustomerID) REFERENCES Customers (CustomerID);
ALTER TABLE Repair_Job ADD CONSTRAINT FKRepair_Job882888 FOREIGN KEY (MACHINEID) REFERENCES Machines (MachineID);
...
ALTER TABLE MyCluster_Machine ADD CONSTRAINT FKMyCluster_Machine2 FOREIGN KEY (MachineID) REFERENCES Machines (MachineID);
